...
loop: subi r9, r9, 1
       ble r9, r0, finished # count down to totoal numbers
	   
	   addi r10,r10,4   # add 4 to pointer to the numbers to point to next one
	   
	   ldw  r12, (r10)  # load the next number into r12
	   
	   blt  r11, r12, loop  # if the current biggest is still biggest, go to loop
...
numbers: .word 4,5,3,6
	.word 1, 8, 2, 34, 35, 7, 12, 68, 45, 9, 99
